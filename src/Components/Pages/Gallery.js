                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form onSubmit={ev => this.Save(ev)}>
                                    ISBN<input type="text" className="form-control mb-2"value={this.state.isbn} onChange={ ev => this.setState({isbn:ev.target.value}) }required />
                                    judul Buku<input type="text" className="form-control mb-2"value={this.state.judul} onChange={ ev => this.setState({judul:ev.target.value}) }required />
                                    Penulis Buku<input type="text" className="form-control mb-2"value={this.state.penulis} onChange={ ev => this.setState({penulis: ev.target.value}) }required />
                                    Penerbit Buku<input type="text" className="form-control mb-2"value={this.state.penerbit}onChange={ ev => this.setState({penerbit: ev.target.value}) }required />
                                    Harga Buku<input type="number" className="form-control mb-2"value={this.state.harga}onChange={ ev => this.setState({harga:ev.target.value}) }required />
                                    Cover Buku<input type="url" className="form-control mb-2"value={this.state.cover}onChange={ ev => this.setState({cover:ev.target.value}) }required />
                                    <button className="btn btn-info btn-succes" type="submit">Simpan</button>
                                    {/* <button className="btn btn-info btn-danger" type="submit" onClick={handleCancelEdit}>Batal</button> */}
                                    {/* <button onClick={()=>history.back(-1)}>kmn</button> */}
                                </form>
                            </div>
                        </div>
                    </div>
